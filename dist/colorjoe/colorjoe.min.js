!(function (e, n) {
  ...
  var r = {
      ...
      alpha: function (e, t) {
        ...
        function r(e) {
            var clampedX = v.clamp(e.x, 0, 1); // Clamp the x-coordinate
            v.X(e.pointer, clampedX); // Set the position of the pointer horizontally
            t.setAlpha(1 - clampedX); // Update the alpha value based on the horizontal position
        }
    
        return {
            change: function (e) {
                // Set the initial position of the pointer based on the alpha value
                v.X(n.pointer, 1 - e.alpha());
            },
        };
    },
    ...
    y = function (r) {
      return (
        (e = u),
        (n = [r.init, r.xy, r.z]).map(e).filter(s).length != n.length
                    ...
                    if (n) {
                      ...
                      n.forEach(function (e, n) {
                        ...
                        var t,
                          r,
                          a,
                          i = l in x.extras ? x.extras[l] : null;
                        if (i)
                          for (var o in (s = i(
                            c,
                            ((r = l + n),
